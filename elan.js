...
export default class ElanPlugin {
    ...
    render() {
        ...
        console.log(this.data.alignableAnnotations);
        //this.renderedAlignable = this.data.alignableAnnotations.filter(alignable => backRefs[alignable.id]);
        //this.renderedAlignable = this.data.alignableAnnotations.filter(alignable => tiers[0].annotations[alignable.id]);
        this.renderedAlignable = this.data.tiers[0].annotations;
        //this.renderedAlignable = this.data.alignableAnnotations;
        console.log(this.renderedAlignable);
        // table
